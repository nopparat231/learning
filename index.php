      ...
      <div class="row">
        ...
        <div class="text-right col-md-6" style="">
          <form class="" id="c_form-h" action="register_db.php" method="post">
            ...
            <div class="form-group row"> <label for="inputpasswordh" class="col-2 col-form-label text-left">รหัสผ่าน<br class="text-left"></label>
              <div class="col-10">
            ...
            <div class="form-group row"> <label for="inputpasswordh" class="col-2 col-form-label text-nowrap">ยืนยันรหัสผ่าน<br></label>
              <div class="col-10">
                <input type="password" name="" class="form-control" id="inputpasswordh" required="กรุณากรอกยืนยันรหัสผ่าน" placeholder="กรุณากรอกรหัสผ่าน"> </div>
            </div>
            <div class="form-group row"><label class="col-2 text-left">ชื่อ</label>
              <div class="col-10">
                <div class="input-group">
            ...
            <div class="form-group row"><label class="col-2 text-left">นามสกุล</label>
              <div class="col-10">
                <div class="input-group">
            ...
            <div class="form-group row"> <label for="inputmailh" class="col-2 col-form-label text-left">อีเมล์</label>
              <div class="col-10">
                <input type="email" name="email" class="form-control" id="inputmailh" required="กรุณากรอกอีเมล์" placeholder="กรุณากรอกอีเมล์"> </div>
            </div>
            <div class="form-group row"><label class="col-2 text-left">เบอร์โทร<br></label>
              <div class="col-10">
                <div class="input-group">

...
<body>
  ...
  <div class="py-3" style="">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="">Heading 2 <small class="text-muted">subtitle</small></h2>
          <ol class="">
            <li>One</li>
            <li>Two</li>
            <li>Three</li>
  ...
  <div class="py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center"><a class="btn btn-secondary" href="score.html">ส่งคำตอบ</a></div>
      </div>
    </div>
  </div>
  <div class="py-3">
  ...
  <nav class="navbar navbar-expand-md navbar-light bg-light">
    <div class="container"> <button class="navbar-toggler navbar-toggler-right border-0" type="button" data-toggle="collapse" data-target="#navbar12">
      ...
      <div class="collapse navbar-collapse" id="navbar12"> <a class="navbar-brand d-none d-md-block" href="#">
        ...
        <ul class="navbar-nav mx-auto">
          <li class="nav-item"> <a class="nav-link" href="#">บทเรียน</a> </li>
          <li class="nav-item"> <a class="nav-link" href="#">บัญชีผู้ใช้</a> </li>

...
<form name="form1" method="post" action="choice_check.php">
        ...
        <div class="row">
          ...
          <div class="col-md-10">
           ...
           while($result=mysqli_fetch_array($db_query))
           {
            ...
            <ol>
              <input name="c<?php echo $i;?>" type="radio" value="1" checked>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <a class="btn btn-secondary" type="submit" href="choice_check.php">ส่งคำตอบ</a></div>
        </div>
      </div>
    </div>
    <div class="py-3">
